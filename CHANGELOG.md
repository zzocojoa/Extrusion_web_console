...
- Added a default-off, read-only V2 date-scoped delete UI gate and a
  non-mutating Upload page shell with Korean/English copy; this does not add a
  date-scoped delete API, does not enable the feature gate through Settings
  save, and does not approve destructive delete verification.
