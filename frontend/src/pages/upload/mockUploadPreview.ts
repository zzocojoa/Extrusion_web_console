...
const baseItems: PreviewItem[] = [
  {
    ...
    path: "demo://upload-preview/integrated_plc_sample_A.csv",
    fileDate: "2026-06-01",
    sizeBytes: 8_821_234,
  ...
  },
  {
    ...
    kind: "plc",
    folderLabel: "PLC",
    filename: "integrated_plc_sample_B.csv",
    path: "demo://upload-preview/integrated_plc_sample_B.csv",
    fileDate: "2026-06-01",
    sizeBytes: 8_103_554,
  ...
  },
  {
    ...
    kind: "plc",
    folderLabel: "PLC",
    filename: "integrated_plc_sample_C.csv",
    path: "demo://upload-preview/integrated_plc_sample_C.csv",
    fileDate: "2026-06-01",
    sizeBytes: 7_402_120,
  ...
  },
  {
    ...
    kind: "plc",
    folderLabel: "PLC",
    filename: "legacy_plc_schema_sample.csv",
    path: "demo://upload-preview/legacy_plc_schema_sample.csv",
    fileDate: "2026-06-01",
    sizeBytes: 2_231_902,
  ...
  },
  {
    ...
    kind: "plc",
    folderLabel: "PLC",
    filename: "integrated_plc_sample_D.csv",
    path: "demo://upload-preview/integrated_plc_sample_D.csv",
    fileDate: "2026-06-01",
    sizeBytes: 931_204,
