...
def collect_records(
    ...
    *,
    ...
    chunks = list(reader.iter_records(file_row(path, kind=kind, file_date=file_date), chunk_rows=2))
...
def materialize_cp949_fixture(source_name: str, destination: Path) -> Path:
