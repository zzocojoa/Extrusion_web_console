...
Write-AssemblyInfo "  3. Start the package with launcher/start_web_console.ps1 -NoBrowser and smoke /, /upload, /logs, /settings, /api/health, /api/config, /api/audit?limit=1, and /api/runtime/local-supabase."
